package hu.elte.patternmatcher.parser3;
...
public class LR1 {
    ...
    static void LRParser() {
        ...
        while (resume == 1) {
            ...
            case '+': {
                if (stateOfStack == 1 || stateOfStack == 8)
                    shift(6);
                else if (stateOfStack == 2)
                    ReductionHandler(2);
                else if (stateOfStack == 3)
                    ReductionHandler(4);
                else if (stateOfStack == 5)
                    ReductionHandler(6);
                else if (stateOfStack == 9)
                    ReductionHandler(1);
                else if (stateOfStack == 10)
                    ReductionHandler(3);
                else if (stateOfStack == 11)
                    ReductionHandler(5);
                else
                    InvalidString();
                break;
            ...
            case '*': {
                if (stateOfStack == 2 || stateOfStack == 9)
                    shift(7);
                else if (stateOfStack == 3)
                    ReductionHandler(4);
                else if (stateOfStack == 5)
